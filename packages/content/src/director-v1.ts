...
export function validateDirectorPack(value: unknown): DirectorPack {
  ...
  if (rules.recentWindowSize !== 8 || rules.continuityWindow !== 3 || rules.firstRunWindowNodes !== 3 || rules.majorSalienceThreshold !== 4 || rules.majorGapNodes !== 2 || rules.randomDangerGapNodes !== 1) fail("directorPack.rules", "v1 pacing constants are frozen");
...
export const DIRECTOR_V1: DirectorPack = validateDirectorPack({
  ...
  rules: {
    ...
    majorSalienceThreshold: 4, majorGapNodes: 2, randomDangerGapNodes: 1,
