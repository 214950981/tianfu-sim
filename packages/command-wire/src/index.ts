...
export const COMMAND_ACTION_IDS = ["cultivate", "travel", "worldly", "pursuit"] as const;
...
export type GameCommand =
  ...
  | { type: "CHOOSE_ACTION"; actionId: CommandActionId; pursuitCauseId?: string }
...
const actionTypes = new Set<string>(COMMAND_ACTION_IDS);
